      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <nav className="w-60 bg-white border-r-2 border-[#0A0A0A] flex flex-col shrink-0 sticky top-0 h-screen overflow-y-auto">
          <div className="p-4 border-b-2 border-[#0A0A0A]">
            ...
            <p className="font-black text-sm text-[#0A0A0A] mt-0.5 leading-tight">
              {domain.title}
            </p>
          ...
          <div className="p-2 flex-1">
            <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-2 py-2">
              Tasks
            </p>
                  ...
                  {activeSubmission?.repoUrl && (
                    <div className="mb-4 flex items-center gap-2 text-sm">
                      ...
                      <a
                        ...
                        className="font-bold text-[#0A0A0A] underline underline-offset-2 flex items-center gap-1"
                      >
                  ...
                  <div className="flex gap-3">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 border-2 border-[#0A0A0A] bg-white font-medium text-sm focus:outline-none focus:bg-[#FFF9E6]"
                      />
                    </div>
                    <button
                      onClick={() => handleSubmitProject(activeTask.id)}
                      disabled={submitting || !repoUrl.trim()}
                      className="flex items-center gap-2 px-6 py-3 bg-[#FFC107] border-2 border-[#0A0A0A] text-[#0A0A0A] font-black uppercase tracking-wider text-sm shadow-[3px_3px_0px_#0A0A0A] hover:shadow-[5px_5px_0px_#0A0A0A] hover:-translate-x-[1px] hover:-translate-y-[1px] transition-all whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {submitting ? (
